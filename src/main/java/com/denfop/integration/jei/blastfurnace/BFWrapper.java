...
public class BFWrapper implements IRecipeWrapper {
    ...
    public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        ...
        minecraft.fontRenderer.drawString(Localization.translate("iu.blastfurnace.info3") + Localization.translate(new ItemStack(IUItem.blastfurnace, 1, 0).getUnlocalizedName()), 75, 35, 4210752);
