...
public class ItemEnergyDrill extends ItemTool implements IElectricItem, IUpgradeWithBlackList, IModelRegister {
    ...
    public void registerModels(final String name) {
        ModelLoader.setCustomMeshDefinition(this, stack -> {
            ...
            return getModelLocation1("drill", nbt.getString("mode"));
        ...
        for (final String s : mode) {
            ...
            ModelBakery.registerItemVariants(this, getModelLocation1("drill", s));
