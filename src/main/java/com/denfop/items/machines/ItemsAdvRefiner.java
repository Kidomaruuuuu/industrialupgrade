...
public class ItemsAdvRefiner extends ItemMulti<ItemsAdvRefiner.Types> implements IModelRegister {

    protected static final String NAME = "adv_refiner_item";

    public ItemsAdvRefiner() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityAdvOilRefiner te = new TileEntityAdvOilRefiner();
