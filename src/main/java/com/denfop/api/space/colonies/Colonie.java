...
public class Colonie implements IColonie {
    ...
    public Colonie(IBody body, FakePlayer player) {
        this.level = 1;
        this.body = body;
    ...
    public Colonie(NBTTagCompound tag,FakePlayer fakeplayer) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (type){
                ...
                case "storage":
                    ...
                    break;
                case "house":
                    new ColonieHouse(nbt,this);
                    break;
                case "solar":
                    new ColoniePanelFactory(nbt,this);
                    break;
                case "factory":
    ...
    public void update() {
        if(this.enumProblemsList.size() > 0) {
            if (toDelete == 0) {
                SpaceNet.instance.getColonieNet().removeColonie(this, this.getFakePlayer());
            } else {
                toDelete -= 1;
            }
        }else
        ...
        for(IColonieBuilding building : this.list)
            building.work();
    }
    ...
    public boolean equals(final Object o) {
        ...
        Colonie colonie = (Colonie) o;
        return this.fakeplayer.equals(colonie.fakeplayer) && this.body.equals(((Colonie) o).body);
    }
