...
public class RotorUpgradeItemInform {
    ...
    public String getName() {
        switch (this.upgrade) {
            ...
            case STRENGTH_II:
            case STRENGTH_III:
                return TextFormatting.YELLOW + Localization.translate("wind.strength_info") + TextFormatting.GREEN + ModUtils.getString(( this.upgrade.getCoef()  * this.number) * 100) + "%";
            case POWER_I:
            case POWER_II:
            case POWER_III:
                return TextFormatting.AQUA + Localization.translate("wind.power_info") + TextFormatting.GREEN + ModUtils.getString( this.upgrade.getCoef() * this.number * 100) + "%";
            case EFFICIENCY_I:
            case EFFICIENCY_II:
            case EFFICIENCY_III:
                return TextFormatting.GOLD + Localization.translate("wind.efficiency_info") + TextFormatting.GREEN + ModUtils.getString( this.upgrade.getCoef() * this.number * 100) + "%";
            case AUTO:
