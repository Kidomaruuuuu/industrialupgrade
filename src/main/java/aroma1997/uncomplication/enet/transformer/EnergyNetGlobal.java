...
public class EnergyNetGlobal implements IAdvEnergyNet {
    ...
    public static EnergyNetLocal getForWorld(final World world) {
        ...
        if (!EnergyNetGlobal.worldToEnergyNetMap.containsKey(id)) {
            EnergyNetGlobal.worldToEnergyNetMap.put(id, new EnergyNetLocal(world));
        }
        return EnergyNetGlobal.worldToEnergyNetMap.get(id);
    }
    @Override
